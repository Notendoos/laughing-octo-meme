...
export const themeContract = createThemeContract({
  color: {
    ...
    highlight: null,
    wordGridEmpty: null,
    wordGridMissing: null,
    wordGridPresent: null,
    wordGridCorrect: null,
    wordGridSeed: null,
    wordGridText: null,
    confettiPrimary: null,
    confettiSecondary: null,
  },
  font: {
    primary: null,
    secondary: null,
...
const DEFAULT_WORD_GRID_STATE_COLORS = {
...
type ThemePalette = {
  ...
  color: {
    ...
    onInfo: string;
    overlay: string;
    wordGridEmpty?: string;
    wordGridMissing?: string;
    wordGridPresent?: string;
    wordGridCorrect?: string;
    wordGridSeed?: string;
    wordGridText?: string;
...
export const chromaVariants: Record<string, ThemePalette> = {
  classic: {
    ...
    color: {
      ...
      wordGridEmpty: "rgba(248, 247, 241, 0.08)",
      wordGridMissing: "#0d060f",
      wordGridPresent: "#facc15",
      wordGridCorrect: "#22c55e",
      wordGridSeed: "#f97316",
      wordGridText: "#f8f7f1",
      confettiPrimary: "#facc15",
      confettiSecondary: "#22c55e",
    },
  },
  ocean: {
    label: "Ocean",
    ...
    color: {
      ...
      wordGridEmpty: "rgba(235, 248, 255, 0.08)",
      wordGridMissing: "#010b13",
      wordGridPresent: "#0ea5e9",
      wordGridCorrect: "#2dd4bf",
      wordGridSeed: "#38bdf8",
      wordGridText: "#ebf8ff",
      confettiPrimary: "#34d399",
      confettiSecondary: "#0ea5e9",
    },
  },
  sunset: {
    label: "Sunset",
    ...
    color: {
      ...
      wordGridEmpty: "rgba(255, 210, 177, 0.08)",
      wordGridMissing: "#12020e",
      wordGridPresent: "#fb923c",
      wordGridCorrect: "#34d399",
      wordGridSeed: "#f97316",
      wordGridText: "#fff1e6",
      confettiPrimary: "#fb923c",
      confettiSecondary: "#34d399",
    },
  },
  dark: {
    label: "Dark",
    ...
    color: {
      ...
      wordGridEmpty: "rgba(255, 255, 255, 0.04)",
      wordGridMissing: "#070a10",
      wordGridPresent: "#5eead4",
      wordGridCorrect: "#2dd4bf",
      wordGridSeed: "#38bdf8",
      wordGridText: "#f8fafc",
      confettiPrimary: "#5eead4",
      confettiSecondary: "#38bdf8",
    },
  },
};
...
const retroPalettes: Record<string, ThemePalette> = {
  windows95: {
    ...
    color: {
      ...
      wordGridEmpty: "rgba(255, 255, 255, 0.4)",
      wordGridMissing: "#c0c0c0",
      wordGridPresent: "#000080",
      wordGridCorrect: "#007f0e",
      wordGridSeed: "#1f4ed1",
      wordGridText: "#0b0b0b",
      confettiPrimary: "#000080",
      confettiSecondary: "#007f0e",
    },
  },
  oldskool: {
    label: "Oldskool",
    ...
    color: {
      ...
      wordGridEmpty: "#fdf1e0",
      wordGridMissing: "#3f3f3f",
      wordGridPresent: "#e65100",
      wordGridCorrect: "#2a9d8f",
      wordGridSeed: "#ff8a50",
      wordGridText: "#281c14",
      confettiPrimary: "#e65100",
      confettiSecondary: "#2a9d8f",
    },
  },
  vaporwave: {
    label: "Vaporwave",
    ...
    color: {
      ...
      wordGridEmpty: "rgba(255, 255, 255, 0.08)",
      wordGridMissing: "#12002b",
      wordGridPresent: "#7c94ff",
      wordGridCorrect: "#66ffb8",
      wordGridSeed: "#ff5ef7",
      wordGridText: "#f9f3ff",
      confettiPrimary: "#7c94ff",
      confettiSecondary: "#66ffb8",
    },
  },
};
...
const extraChromas: Record<string, ThemePalette> = {
  forest: {
    ...
    color: {
      ...
      onInfo: "#022c22",
      overlay: "rgba(255, 255, 255, 0.04)",
      wordGridEmpty: "rgba(4, 10, 7, 0.8)",
      wordGridMissing: "#021003",
      wordGridPresent: "#86efac",
      wordGridCorrect: "#4ade80",
      wordGridSeed: "#22c55e",
      wordGridText: "#ecfdf5",
      confettiPrimary: "#86efac",
      confettiSecondary: "#4ade80",
    },
  },
  neonMatrix: {
    label: "Neon Matrix",
    ...
    color: {
      ...
      wordGridEmpty: "rgba(0, 8, 4, 0.85)",
      wordGridMissing: "#001004",
      wordGridPresent: "#00ff88",
      wordGridCorrect: "#00ff88",
      wordGridSeed: "#5cffb0",
      wordGridText: "#eafff4",
      confettiPrimary: "#00ff88",
      confettiSecondary: "#5cffb0",
    },
  },
  sakura: {
    label: "Sakura",
    ...
    color: {
      ...
      wordGridEmpty: "#fff1f6",
      wordGridMissing: "#7a445c",
      wordGridPresent: "#ec4899",
      wordGridCorrect: "#4ade80",
      wordGridSeed: "#f9a8d4",
      wordGridText: "#3f1d2f",
      confettiPrimary: "#ec4899",
      confettiSecondary: "#4ade80",
    },
  },
  midnightPurple: {
    ...
    color: {
      ...
      onInfo: "#041824",
      overlay: "rgba(255, 255, 255, 0.05)",
      wordGridEmpty: "rgba(245, 243, 255, 0.06)",
      wordGridMissing: "#07010f",
      wordGridPresent: "#c4b5fd",
      wordGridCorrect: "#34d399",
      wordGridSeed: "#a78bfa",
      wordGridText: "#f5f3ff",
      confettiPrimary: "#c4b5fd",
      confettiSecondary: "#34d399",
    },
  },
  lava: {
    ...
    color: {
      ...
      onInfo: "#2b1604",
      overlay: "rgba(255, 255, 255, 0.04)",
      wordGridEmpty: "rgba(255, 245, 245, 0.1)",
      wordGridMissing: "#0a0202",
      wordGridPresent: "#ef4444",
      wordGridCorrect: "#22c55e",
      wordGridSeed: "#fca5a5",
      wordGridText: "#fff5f5",
      confettiPrimary: "#ef4444",
      confettiSecondary: "#22c55e",
    },
  },
  arctic: {
    ...
    color: {
      ...
      wordGridEmpty: "rgba(248, 250, 252, 0.5)",
      wordGridMissing: "#0f172a",
      wordGridPresent: "#0ea5e9",
      wordGridCorrect: "#22c55e",
      wordGridSeed: "#7dd3fc",
      wordGridText: "#0f172a",
      confettiPrimary: "#0ea5e9",
      confettiSecondary: "#22c55e",
    },
  },
  triage: {
    label: "Triage",
    description: "Clinical high-contrast with diagnostic accents",
    color: {
      background: "#05060a",
      surface: "rgba(5, 7, 18, 0.95)",
      surfaceAlt: "rgba(14, 22, 35, 0.9)",
      accent: "#facc15",
      accentLight: "#fcd34d",
      accentStrong: "#f97316",
      border: "rgba(250, 204, 21, 0.4)",
      borderLight: "rgba(250, 204, 21, 0.2)",
      text: "#ecfdf5",
      subtext: "rgba(236, 253, 245, 0.75)",
      info: "#22d3ee",
      success: "#14b8a6",
      ...
      onInfo: "#021826",
      overlay: "rgba(255, 255, 255, 0.04)",
      wordGridEmpty: "rgba(236, 253, 245, 0.05)",
      wordGridMissing: "#040913",
      wordGridPresent: "#facc15",
      wordGridCorrect: "#22c55e",
      wordGridSeed: "#38bdf8",
      wordGridText: "#ecfdf5",
...
const applyColorVariant = (
  ...
  const gridEmpty =
    palette.wordGridEmpty ?? DEFAULT_WORD_GRID_STATE_COLORS.empty;
  const gridMissing =
    palette.wordGridMissing ?? DEFAULT_WORD_GRID_STATE_COLORS.missing;
  const gridPresent =
    palette.wordGridPresent ?? DEFAULT_WORD_GRID_STATE_COLORS.present;
  const gridCorrect =
    palette.wordGridCorrect ?? DEFAULT_WORD_GRID_STATE_COLORS.correct;
  const gridSeed =
    palette.wordGridSeed ?? DEFAULT_WORD_GRID_STATE_COLORS.seed;
  const gridText =
    palette.wordGridText ?? DEFAULT_WORD_GRID_STATE_COLORS.text;
  const confettiPrimary =
    palette.confettiPrimary ?? DEFAULT_CONFETTI_COLORS.primary;
  const confettiSecondary =
    palette.confettiSecondary ?? DEFAULT_CONFETTI_COLORS.secondary;
  globalStyle(selector, {
    vars: {
      ...
      [themeContract.color.wordGridEmpty]: gridEmpty,
      [themeContract.color.wordGridMissing]: gridMissing,
      [themeContract.color.wordGridPresent]: gridPresent,
      [themeContract.color.wordGridCorrect]: gridCorrect,
      [themeContract.color.wordGridSeed]: gridSeed,
      [themeContract.color.wordGridText]: gridText,
      [themeContract.color.confettiPrimary]: confettiPrimary,
      [themeContract.color.confettiSecondary]: confettiSecondary,
    },
  });
};
